import styles from './ProductDetailSpecialInstructions.module.css';
 ...
 * instructions.
 */
function ProductDetailSpecialInstructions({ value, onChange }) {
  return (
...
export default ProductDetailSpecialInstructions;
