...
function MissionDescription({
  children = 'Our mission is to serve crave-worthy food with the speed people need and the care they deserve. Every BiteX order should feel easy, exciting, and worth coming back for.',
}) {
